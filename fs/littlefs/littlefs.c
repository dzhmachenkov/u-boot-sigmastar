...
#define LITTLEFS_BLK_SIZE                       0x20000//128KB
#elif defined(CONFIG_MS_PARTITION)
#define LITTLEFS_BLK_SIZE                       0x8000//3
#endif
...
S32  littlefs_mount(char *partition, char *mnt_path)
{
    ...
    //printf("%s:[%d,%d,%d,%d]\n",__FUNCTION__,_gLfsMntHandle.cfg.page_size,_gLfsMntHandle.cfg.block_size,
    //    _gLfsMntHandle.cfg.block_count,_gLfsMntHandle.cfg.block_offset);
