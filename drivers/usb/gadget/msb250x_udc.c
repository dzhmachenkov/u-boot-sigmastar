...
static void msb250x_ep_fifo_flush(struct usb_ep* _ep)
{
    ...
    if (0 == ep->ep_num)
    {
        ms_writeb(ms_readb(MSB250X_OTG0_EP0_CSR0_FLSH_REG) | MSB250X_OTG0_CSR0_FLUSHFIFO, MSB250X_OTG0_EP0_CSR0_FLSH_REG);
    }
    else
    {
        if (usb_endpoint_dir_in(ep->desc))
        ...
        {
            ms_writeb(ms_readb(MSB250X_OTG0_EP_RXCSR1_REG(ep->ep_num)) | MSB250X_OTG0_RXCSR1_FLUSHFIFO, MSB250X_OTG0_EP_RXCSR1_REG(ep->ep_num));
        }
    }
}
