...
#include "stdbool.h"
#include "asm/arch-infinity6/mach/platform.h"
#include "asm/arch-infinity6/mach/ms_types.h"
#include "mhal_gpio.h"
#include "padmux.h"
#include "gpio.h"
...
static void _HalPadSetPadMux(U32 u32PadModeID)
{
	printf("HalPadSetPadMux %x ", u32PadModeID);
	printf("RIU %x mask %x\r\n", m_stPadModeInfoTbl[u32PadModeID].u32ModeRIU, m_stPadModeInfoTbl[u32PadModeID].u32ModeMask);
	printf("Va %x\r\n",_GPIO_R_WORD_MASK(m_stPadModeInfoTbl[u32PadModeID].u32ModeRIU, m_stPadModeInfoTbl[u32PadModeID].u32ModeMask));
//    if (_GPIO_R_WORD_MASK(m_stPadModeInfoTbl[u32PadModeID].u32ModeRIU, m_stPadModeInfoTbl[u32PadModeID].u32ModeMask)) {
        _GPIO_W_WORD_MASK(m_stPadModeInfoTbl[u32PadModeID].u32ModeRIU, 0xFFFF, m_stPadModeInfoTbl[u32PadModeID].u32ModeMask);
