...
int HwI2cReadByte(u_char chipAddr, uint regAddr, char* buf)
{
	return i2c_read(chipAddr, regAddr, 1, (uint8_t*)buf, 1);
}
int HwI2cWrtieByte(u_char chipAddr, uint regAddr, char dat)
{
	return i2c_write(chipAddr, regAddr, 1, &dat, 1);
}
